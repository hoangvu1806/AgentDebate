...
class TopicExtractor:
    ...
    def _build_prompt(self, raw_input: str) -> str:
        return (
            ...
            "EXAMPLES:\n"
            "Input: 'Is AI good or bad?' -> 'Artificial intelligence brings more benefit than harm to society.'\n"
            "Input: 'remote work vs office' -> 'Remote work is superior to traditional office work.'\n"
            "Input: 'Should we ban TikTok?' -> 'TikTok should be banned in democratic countries.'\n\n"
            f"User input:\n{raw_input}\n\n"
            "Proposition:"
        )
